...
namespace Qs3_inheritance
{
    ...
    {
        public Vector3() : base() { Num++; }
        public Vector3(float x, float y, float z) : base(x, y, z) { Num++; }
        public Vector3(BaseVector v) : base(v) { Num++; }
        //static.
        protected static new int Num { get; private set; }
        ...
        {
            Console.WriteLine("Vector3のインスタンス数は:{0}", Num);
        }
    ...
    class AbVector3 : AbstVector
    {
        ...
        public override float GetMgunitude()
        {
            return MathF.Sqrt(this.X * this.X + this.Y * this.Y + this.Z * this.Z);
        }
    }
    ...
    /*問題3*/
    class GameObject : Position,Grafic,Move
    {
        public float X { get; set; }
        public float Y { get; set; }
        public float Z { get; set; }
        ...
        //コンストラクタ
        public GameObject() { X = 0;Y = 0;Z = 0;FileName = ""; }
        ...
        public void MovePos()
        {
            Console.WriteLine("本来は移動する処理を書きましょう。");
        }
    }
}
