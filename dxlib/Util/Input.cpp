...
Input::Input()
{
	...
	commandTable["CANCEL"] = { {InputType::KeyBoard, KEY_INPUT_ESCAPE},
...
#ifdef _DEBUG
	commandTable["end"] = { {InputType::KeyBoard, KEY_INPUT_R},
							{InputType::Pad, PAD_INPUT_Y} };

	commandTable["Goal"] = { {InputType::KeyBoard, KEY_INPUT_G},
